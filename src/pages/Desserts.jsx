            ...
            return (
                <div className="bg-white rounded-md h-80 px-4 pt-4" key={item.uuid} >
                    <Link
                        ...
                        style={{ textDecoration: 'none' }}
                    >
                        <img className="w-60 h-40 rounded-t-md object-cover" src={`../images/${item.image}`} />
                        <div>
                            <h3 className="text-teal-900 font-bold px-4 w-60 pt-5 text-center text-xl">{item.name}</h3>
                        </div>
                    </Link>
                </div>
